class ProfessionalsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @professional.save
        format.html { redirect_to new_professional_path, flash:{success: true, messages: "Se creo el profesional con éxito" } }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to root_path, notice: "Professional was successfully destroyed." }
